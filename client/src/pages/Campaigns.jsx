                                ...
                                <tbody>
                                    {campaigns.map(c => (
                                        <tr key={c.id} className="border-b border-gray-50 last:border-0 hover:bg-gray-50/50 transition-colors group">
                                            ...
                                            <td className="px-8 py-6">
                                                <span className={`px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest border ${c.status === 'completed' ? 'bg-emerald-50 text-emerald-600 border-emerald-100' :
